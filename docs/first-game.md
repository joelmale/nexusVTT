...
current tooling writes processed assets under `apps/vtt/static-assets/assets` and serves
library assets through the standalone asset service in `apps/vtt/services/asset-service`.
...
If images do not load, verify processed assets exist under `apps/vtt/static-assets/assets`
