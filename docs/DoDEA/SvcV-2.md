...
flowchart LR
  ...
  wsService -->|fanout, presence, host lease| redis
...
| Realtime Collaboration Service | Persistence Service            | Session activation, canonical snapshot compare-and-swap, ordered event journal | SQL                       |
| Realtime Collaboration Service | Redis Service                  | Versioned cross-replica fanout, expiring presence, host leases                 | Redis commands/pub-sub    |
