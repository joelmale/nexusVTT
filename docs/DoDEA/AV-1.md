...
| Canonical game state uses transactional compare-and-swap                                                  | Snapshot, content hash, version, and campaign scenes commit before ACK; concurrent replica losers rebase from the authoritative tuple. |
