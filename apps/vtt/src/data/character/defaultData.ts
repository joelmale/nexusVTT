...
export const PLACEHOLDER_ARMOR: Armor[] = [
  // Light Armor
  {
    id: 'padded',
    name: 'Padded',
...
export const PLACEHOLDER_SPELLS: Spell[] = [
  // Cantrips
  {
    id: 'acid-splash',
    name: 'Acid Splash',
...
export const PLACEHOLDER_EQUIPMENT: Equipment[] = [
  // Adventuring Gear
  {
    id: 'backpack',
    name: 'Backpack',
...
export const PLACEHOLDER_PERSONALITY: PersonalityData = {
  traits: [
...
export const PLACEHOLDER_CLASSES: CharacterClass[] = [
  {
    name: 'Barbarian',
    level: 1,
    hitDie: 'd12',
...
export const PLACEHOLDER_RACES: CharacterRace[] = [
  // Core Races
  {
    name: 'Human',
    traits: ['Versatile'],
...
export const PLACEHOLDER_BACKGROUNDS: CharacterBackground[] = [
  {
    name: 'Acolyte',
