...
- Homelab: `apps/docs/vtt/HOMELAB_DEPLOYMENT.md`
- Root production guide: `DEPLOYMENT.md`
- Reverse proxy notes: `apps/docs/vtt/NPM_CONFIGURATION.md`
- NexusCodex homelab details:
  `apps/docs/codex/operations/nexuscodex-homelab.md`
