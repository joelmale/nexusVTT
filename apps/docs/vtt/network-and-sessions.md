...
- [DEPLOYMENT.md](https://github.com/joelmale/nexusVTT/blob/master/DEPLOYMENT.md) - Production deployment guide
- [CLAUDE.md](https://github.com/joelmale/nexusVTT/blob/master/CLAUDE.md) - Full architecture overview
- [apps/vtt/server/schema.sql](https://github.com/joelmale/nexusVTT/blob/master/apps/vtt/server/schema.sql) - Database schema
- [apps/vtt/docker/nginx.conf](https://github.com/joelmale/nexusVTT/blob/master/apps/vtt/docker/nginx.conf) - nginx configuration
