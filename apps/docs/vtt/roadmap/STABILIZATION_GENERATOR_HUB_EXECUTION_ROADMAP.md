...
| S4.2 — Cave Generator migration           | complete | S4.1         | T1                      |                 | Migrated cave-generator to Hub       |
| S4.3 — City Generator migration           | complete | S4.2         | T1                      |                 | Migrated city-generator to Hub       |
| S4.4 — Dwelling Generator migration       | complete | S4.3         | T1                      |                 | Migrated dwellings-generator to Hub  |
...
- [x] **S1.6 — Host authorization:** Move `Room` hydration strictly _after_ authorization. (Check: `npm run test:e2e` soak)
