...
automated sub-1%-diff harness the A8a brief specified. Accepted substitute for this gate:
...
optional, not required. Do not treat "harness re-run below 1%" below as literal.
...
- A8a pixel-harness re-run on final code: still below 1% diff.
