...
protection, add signed thumbnail URLs _for the `/users/*` partition only_ — deferred until
...
(the doc-api pattern) are the _upgrade path_ if proxying uploads ever measurably hurts —
