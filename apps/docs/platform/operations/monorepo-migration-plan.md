...
[ADR-0001](/vtt/roadmap/ADR/nexuscodex-boundary).
...
- [Current VTT deployment guide](https://github.com/joelmale/nexusVTT/blob/master/DEPLOYMENT.md) describes CI publishing,
...
- [Homelab runbook](/codex/operations/nexuscodex-homelab) records Codex volume identities, secret
