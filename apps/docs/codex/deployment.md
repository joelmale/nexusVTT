...
steps:
  - name: 'gcr.io/cloud-builders/docker'
    args:
      ['build', '-t', 'gcr.io/$PROJECT_ID/nexus-codex-api', 'services/doc-api']
  ...
  - name: 'gcr.io/google-appengine/exec-wrapper'
    args:
      [
        '-c',
        'gcloud run deploy nexus-codex-api --image gcr.io/$PROJECT_ID/nexus-codex-api --region us-central1 --platform managed',
      ]
